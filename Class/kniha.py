class Kniha:
    def __init__(self, id, nazov, autor, rok_vydania, zaner, jazyk, poskodenie, je_vypozicana, isbn):
        self.id = id
        self.nazov = nazov
        self.autor = autor
    ...
    def ziskaj_data(self):
        return [self.id, self.nazov, self.autor, self.rok_vydania, self.zaner, self.jazyk, self.poskodenie, self.je_vypozicana, self.isbn]
